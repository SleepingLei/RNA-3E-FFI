...
python scripts/04_train_model.py \
    ...
    --output_dir models/physics_v3_6_0.1_new_improve_pool_physical_loss \
    --use_ddp --world_size 4 --splits_file data/splits/filtered_splits.json \
    --use_v3_model --num_attention_heads 8 --use_improved_layers --grad_clip 2.0 --initial_angle_weight 0.33 --initial_dihedral_weight 0.33 --initial_nonbonded_weight 0.33 \
    #--use_physics_loss \
